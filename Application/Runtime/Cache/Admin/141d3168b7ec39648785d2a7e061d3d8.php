...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb"> <a href="/index.php/Admin/Main/index.html" class="tip-bottom" data-original-title="返回后台首页"><i class="icon-home"></i> 后台首页</a><span>|</span><a href="/index.php/Admin/Notice/drafts"> &nbsp;发部学校新闻</a><span>|</span><a href="/index.php/Admin/Notice/drafts" class="current"> 通知草稿箱</a> </div>
        <h1>通知草稿箱</h1>
    </div>
    <!--End-breadcrumbs-->
    <style type="text/css">
            ...
            <table class="table table-bordered table-striped">
                ...
                <tr>
                    <th style="text-align: left;" colspan="8">
                        ...
                        <span>通知草稿箱</span>
                        <span style="float: right;"><a href="/index.php/Admin/Notice/handleNotice">
                ...
                <form class="form-horizontal" role="form" action="/index.php/Admin/Notice/bdel" method="post">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/index.php/Admin/Notice/edit?id=<?php echo $v['id'];?>"><span>处&nbsp;理</span></a>&nbsp;&nbsp;
