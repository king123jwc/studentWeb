...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb"> <a href="/index.php/Admin/Main/index.html" class="tip-bottom" data-original-title="返回后台首页"><i class="icon-home"></i> 后台首页</a><span>|</span><a href="/index.php/Admin/Teacher/changeData"> &nbsp;教师平台</a><span>|</span><a href="/index.php/Admin/Teacher/tunit" class="current"> 管理社团</a> </div>
        <h1>管理  社团</h1>
    </div>
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/index.php/Admin/Teacher/unitedit?id=<?php echo $v['id'];?>"><span>详&nbsp;情</span></a>&nbsp;&nbsp;
                            <a onclick="return confirm('是否确认删除')" href="/index.php/Admin/Teacher/del?id=<?php echo $v['id'];?>"><span>删&nbsp;除</span></a>
                        </td>
                    </tr>
                    <?php endforeach;?>
