...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb"> <a href="/index.php/Admin/Main/index.html" class="tip-bottom" data-original-title="返回后台首页"><i class="icon-home"></i> 后台首页</a><span>|</span><a href="/index.php/Admin/Delall/deleteunit"> &nbsp;删除</a><span>|</span><a href="/index.php/Admin/Delall/deleteunit" class="current"> 删除未批准社团申请</a> </div>
        <h1>删除 未批准社团申请</h1>
    </div>
    <!--End-breadcrumbs-->
    <style type="text/css">
    ...
    <div class="container-fluid" style="overflow-y: auto; overflow-x: hidden; height: 460px;">
        <div class="table-responsive">
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                <form class="form-horizontal" role="form" action="/index.php/Admin/Delall/bdelunit" method="post">
                    ...
                    <tr>
                        ...
                        <td><span><a href="/Public/<?php echo ($v['cehua']); ?>"><?php echo ($v['cehuaname']); ?></a></span></td>
                        <td><span><?php echo $v['createtime'];?></span></td>
                        <td>
                            <a onclick="return confirm('是否确认删除')" href="/index.php/Admin/Delall/delunit?id=<?php echo $v['id'];?>"><span><i class='icon-remove'></i> 删&nbsp;&nbsp;除</span></a>
                        </td>
                    </tr>
                    <?php endforeach;?>
