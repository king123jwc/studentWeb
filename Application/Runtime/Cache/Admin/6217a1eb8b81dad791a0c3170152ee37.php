...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb"> <a href="/index.php/Admin/Main/index.html" class="tip-bottom" data-original-title="返回后台首页"><i class="icon-home"></i> 后台首页</a><span>|</span><a href="/index.php/Admin/Activity/activityData"> 举办活动</a><span>|</span><a href="/index.php/Admin/Activity/activitySummary" class="current"> 活动总结</a> </div>
        <h1>活动  总结</h1>
    </div>
    <!--End-breadcrumbs-->
    <style type="text/css">
    ...
    <div class="container-fluid" style="overflow-y: auto; overflow-x: hidden; height: 460px;">
        ...
        <form class="form-horizontal" role="form" action="/index.php/Admin/Activity/activitySummary" method="post">
 ...
 if($v['issummary']== 1){ echo "<span><i class='icon-lock'></i> 总结已上传</span><br>
                                    <a href=\"/index.php/Admin/Activity/show?id=".$v['id']."\">查看  总结</a>"; }elseif($v['issummary']== 0){ echo "<a href=\"/index.php/Admin/Activity/edit?id=".$v['id']."\">提交  总结</a>"; } ?>
                            </td>
                        </tr>
                    <?php endforeach;?>
