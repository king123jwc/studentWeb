...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb"> <a href="/index.php/Admin/Main/index.html" class="tip-bottom" data-original-title="返回后台首页"><i class="icon-home"></i> 后台首页</a><span>|</span><a href="/index.php/Admin/Teacher/changeData"> &nbsp;教师平台</a><span>|</span><a href="/index.php/Admin/Teacher/active" class="current"> 发布活动</a> </div>
        <h1>发布  活动</h1>
    </div>
    <!--End-breadcrumbs-->
    <style type="text/css">
    ...
    <div class="container-fluid" style="overflow-y: auto; overflow-x: hidden; height: 400px;">
            <div class="table-responsive">
                <table class="table table-bordered table-striped" style="border: 0">
                    ...
                    <tbody>
                        <form class="form-horizontal" role="form" action="/index.php/Admin/Teacher/active" method="post" ENCTYPE="multipart/form-data">
                        <tr>
