...
<div class="container">
	<div class="main_grid1">
		<h3 class="style pull-left">已结束的活动</h3>
...
<div class="container">
	<div class="about">
        ...
        <?php foreach($data as $k=>$v):?>
			   <h3><?php echo $k+1;?>.已结束的活动</h3>
               <h3>活动名称:  <?php echo $v['activename'];?></h3>
               <h3>活动时间:  <?php echo $v['holdtime'];?></h3>
			   <h3>活动简介:  <?php echo $v['activeinfo'];?></h3>
               <h3>报名人数:  <?php $count=count(explode(',',$v['enterid']))-2; echo $count;?></h3>
			   <h3>下载活动资料:<?php if($v['issummary']==1){echo html_entity_decode($v['summary']);}else{ echo "没有上传活动资料"; }?></h3>	
               <hr color="#000000">
        <?php endforeach;?>       
        </div>
